...
// This category is now CMS-backed (slug "modular-f-r-l--units-filter-regulators"), so this legacy static URL
...
$_GET['category'] = 'modular-f-r-l--units-filter-regulators';
