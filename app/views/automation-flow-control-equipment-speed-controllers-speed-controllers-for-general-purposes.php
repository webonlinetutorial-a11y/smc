...
$speedControllerProducts = [
    [
        'title' => 'Elbow Type/Universal Type/Push-lock Type...',
    ...
    [
        'title' => 'In-line Panel Mount Type',
    ...
    [
        'title' => 'In-line Push Locking Type',
    ...
    [
        'title' => 'With Uni One-touch fitting',
    ...
    [
        'title' => 'Uni Elbow Type/Universal...',
...
$speedControllerProductDetails = [];
foreach ($speedControllerProducts as $product) {
    $speedControllerProductDetails[$product['slug']] = [
...
<main class="automation-page flow-control-equipment-page speed-controllers-page">
    <div class="container">
        <?php require INCLUDES_PATH . DIRECTORY_SEPARATOR . 'breadcrumb.php'; ?>

        <section class="automation-intro flow-control-equipment-intro speed-controllers-intro" aria-labelledby="speed-controllers-title">
            <div class="automation-intro__content">
                <h1 id="speed-controllers-title">Speed Controllers for General Purposes</h1>
                <p>SMC speed controllers help regulate actuator movement with fine adjustment. Boost safety, energy efficiency, and consistency in your system.</p>
            </div>
            <div class="automation-intro__image">
                <img src="<?= e(assetUrl('images/Flow-Control-Equipment/Speed-Controllers/Speed-Controllers-for-General-Purposes -intro.webp')); ?>" alt="Speed Controllers for General Purposes" loading="eager">
            </div>
        </section>

        <section class="automation-categories flow-control-products speed-controller-products" aria-label="Speed controller products">
            <div class="automation-categories__layout">
                <?php renderAutomationCategorySidebar($categorySidebar, 'automation-flow-control-equipment-speed-controllers-speed-controllers-for-general-purposes-category-panel'); ?>
                ...
                <div class="automation-product-selection speed-controller-selection" data-product-detail-shell>
                    ...
                    <section class="automation-selected-product" id="speed-controller-detail" data-product-detail-panel hidden aria-live="polite"></section>
                    <script type="application/json" data-product-detail-data><?= json_encode($speedControllerProductDetails, JSON_UNESCAPED_SLASHES); ?></script>
                </div>
            </div>
        </section>
    </div>
