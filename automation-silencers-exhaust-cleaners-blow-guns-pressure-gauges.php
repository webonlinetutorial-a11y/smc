...
renderView('automation-silencers-exhaust-cleaners-blow-guns-pressure-gauges', [
    'title' => 'Silencers/Exhaust Cleaners/Pressure Gauges/Blow Guns | ' . configValue('app.name', 'Nepack Website'),
    ...
    'breadcrumbs' => [
        ...
        ['label' => 'Silencers/Exhaust Cleaners/Pressure Gauges/Blow Guns'],
    ],
]);
